...
<body>
	...
	<form method="post" action="inscription" class="pt-5 pr-4">
		...
		<div class="form-group">
			...
			<label for="nom" class="col-sm-2 col-form-label">Nom :</label> <input
				type="text" id="nom" name="nom" class="form-control col-sm-4" required>
		</div>
		<div class="form-group">
			...
			<label for="email" class="col-sm-2 col-form-label">Email :</label> <input
				type="text" id="email" name="email" class="form-control col-sm-4" required>
		</div>
		<div class="form-group">
			...
			<label for="rue" class="col-sm-2 col-form-label">Rue :</label> <input
				type="text" id="rue" name="rue" class="form-control col-sm-4" required>
		</div>
		<div class="form-group">
			...
			<label for="ville" class="col-sm-2 col-from-label">Ville :</label> <input
				type="text" id="ville" name="ville" class="form-control col-sm-4" required>
		</div>
		<div class="form-group">
