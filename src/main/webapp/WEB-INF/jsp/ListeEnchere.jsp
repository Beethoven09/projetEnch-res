	...
	<div id="body" class="mx-auto mt-5 ">
		...
		<header id="header-connexion">
			<div class="text-right mr-2 mb-4 mt-1">
				<!-- options utilisateur -->
				<a href="NouvelleVente">Enchères</a>| <a href="NouvelleVente">Vendre
					un article</a> | <a href="inscription">Mon profil</a> | <a
			...
			<div class="row mx-auto" id="row-categories">
				<div
					...
					<aside>
						...
						<ul>
							<li><label for="achats">Achats:</label> <select id="achats"
								name="achats">
							...
							<li><label for="ventes">Ventes:</label> <select id="ventes"
								name="ventes">
